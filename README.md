...
4. If you need `WebSearch`, add `PARALLEL_API_KEY` as a secret environment-variable binding for **Development**, **Staging**, and **Production**. Bindings are environment-specific.
